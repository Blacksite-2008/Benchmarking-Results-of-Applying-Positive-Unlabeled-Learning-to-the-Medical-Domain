...
dataset= str(sys.argv[12])

#python train_nnpu_sigmoid_main.py -num_initial_pos 1000 -learning_rate 3 -weight_decay 8 -num_batches 3 -seed 1 - dataset mit
train_nnpu_sigmoid(num_initial_pos, learning_rate, weight_decay, num_batches, seed, dataset)
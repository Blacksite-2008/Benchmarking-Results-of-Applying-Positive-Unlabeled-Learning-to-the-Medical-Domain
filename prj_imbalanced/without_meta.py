...
def train_nnpu_sigmoid(num_initial_pos, learning_rate, weight_decay, num_batches, seed, dataset):
    ...
    # Load data set
    xy_pos_train, xy_unlabel_train, xy_pos_test, xy_neg_test, prior = load_dataset(dataset, 300, 22797, seed)
    ...
    for epoch in range(epochs):
        ...
        savename = '/home/Student/s4570079/prj_imbalanced/result/nnpu_sigmoid_result_pos_%i_lr_%i_wd_%i_batches_%i_trial_%i_%s.mat' %(num_initial_pos, learning_rate, weight_decay, num_batches, seed, dataset)

...
class CNN(MyClassifier, Chain):
    def __init__(self, prior, dim):
        super(CNN, self).__init__(
            conv1=L.Convolution2D(1, 200, 3, pad=1),
            conv2=L.Convolution2D(200, 200, 3, pad=1),
            conv3=L.Convolution2D(200, 200, 3, pad=1, stride=2),
            conv4=L.Convolution2D(200, 400, 3, pad=1),
            conv5=L.Convolution2D(400, 400, 3, pad=1),
            conv6=L.Convolution2D(400, 400, 3, pad=1, stride=2),
            conv7=L.Convolution2D(400, 400, 3, pad=1),
            conv8=L.Convolution2D(400, 400, 1),
            conv9=L.Convolution2D(400, 10, 1),
            b1=L.BatchNormalization(200),
            b2=L.BatchNormalization(200),
            b3=L.BatchNormalization(200),
            b4=L.BatchNormalization(400),
            b5=L.BatchNormalization(400),
            b6=L.BatchNormalization(400),
            b7=L.BatchNormalization(400),
            b8=L.BatchNormalization(400),
